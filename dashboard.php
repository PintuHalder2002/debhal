        ...
        <div class="container">
            ...
            <nav class="navbar" data-navbar>
                ...
                <div class="navbar-wrapper">
                    ...
                    <a href="logout/" title="logout as <?php echo htmlspecialchars($_SESSION['full_name']); ?>"
                        class="btn btn-outline label-medium">Log Out</a>
                    <a href="add_post/" class="btn btn-primary btn-outline label-medium" style="color: white;">Add Post
                        +</a>
                    <a href="profile/" title="View Profile" class=""
                        style="color: white; display: flex; justify-content: center;"><span id="account_circle"
            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-content">
                        <p class="body-large hero-text" style="margin-bottom: 0px; font-size: 1.8em;"><i>Welcome <b>
                        ...
                        <form method="GET" action="all_properties/index.php" class="search-bar"
                            ...
                            <label class="search-item">
                                ...
                                <select name="property_owner_type_filter" class="search-item-field body-medium"
                            ...
                            <label class="search-item">
                                ...
                                <select name="property_type_filter" class="search-item-field body-medium"
                                    id="propertyType">
                                    <option value="any" selected>Select</option>
                            ...
                            <script
                                src="https://unpkg.com/@mapbox/mapbox-gl-geocoder/dist/mapbox-gl-geocoder.min.js"></script>
                            <style>
                    ...
                    <div class="title-wrapper">
                        <div>
                            ...
                            <p class="section-text body-large">
                                Explore our latest listings showcasing unique homes and prime locations, perfect for
                                finding your dream property or investment opportunity.
                            </p>
                        </div>
...
require 'db_connect.php';
                            ...
                            <div class="card-banner">
                                <figure class="img-holder" style="--width: 585; --height: 390">
                                    <img src="add_post/<?php echo htmlspecialchars($photos[0] ?? 'uploads/_default_home_pic.avif'); ?>"
                                        ...
                                        style="cursor: pointer; height: 250px; object-position: center;"
                                        class="img-cover"
                                        onclick="viewfullimage(<?php echo htmlspecialchars($photo_list); ?>);"
                                        loading="lazy" />
                                </figure>
                                ...
                                <button class="icon-btn fav-btn" aria-label="add to favorite"
                                    data-property-id="<?php echo htmlspecialchars($row['id']); ?>"
                                ...
                                <script>
                                    function toggleFavorite(button) {
                                        ...
                                        if (favorites.includes(propertyId)) {
                                            ...
                                            button.style.color = 'white'; // Change color to indicate it's favorited
                                            button.style.backgroundColor = 'crimson'; // Change background color
                                        }

                                        localStorage.setItem('favorites', JSON.stringify(favorites));
                                    }

                                    // Call this function when loading the page to set the initial state of the button
                                    function loadFavorites() {
                                        ...
                                        favoriteButtons.forEach(button => {
                                            const propertyId = button.getAttribute('data-property-id');
                                            if (favorites.includes(propertyId)) {
                                                button.style.color = 'white'; // Set as favorited
                                                button.style.backgroundColor = 'crimson'; // Set as favorited
                                            }
                                        });
                                    }
    ...
    ?>
                                    ...
                                    <div class="meta-item">
                                        <span class="material-symbols-rounded meta-icon"
                                            aria-hidden="true">straighte</span>
                                ...
                                <div class="card-meta-list">
                                    <details>
                                        ...
                                        <ul>
                                            ...
                                            <li><b>Bedrooms</b>:
                                                <?php echo ($row['bedrooms'] > 0) ? htmlspecialchars($row['bedrooms']) : 'N/A'; ?>
                                                Bed
                                            </li>

                                            <li><b>Bathrooms</b>:
                                                <?php echo ($row['bathrooms'] > 0) ? htmlspecialchars($row['bathrooms']) : 'N/A'; ?>
                                                Bath
                                            </li>
                ...
                <div class="container">
                    ...
                    <div class="feature-content">
                        ...
                        <p class="body-large feature-text">
                            Looking for a property that reflects your style and offers the perfect balance of comfort
                            and luxury? Whether you're looking to rent or buy, our expertly renovated properties are
                            designed to meet your needs. From modern smart home features to an exceptional lifestyle, we
                            offer spaces you'll love to call home.
                        </p>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>1</td>
                                <td>₹ 13 /-</td>
                                <td><button onclick="handleButtonClick(this)" s-no="1" no-of-ads="1" amount="13">Get
                                        This Plan</button>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>2</td>
                                <td>₹ 25 /-</td>
                                <td><button onclick="handleButtonClick(this)" s-no="2" no-of-ads="2" amount="25">Get
                                        This Plan</button>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>3</td>
                                <td>₹ 36 /-</td>
                                <td><button onclick="handleButtonClick(this)" s-no="3" no-of-ads="3" amount="36">Get
                                        This Plan</button>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>5</td>
                                <td>₹ 55 /-</td>
                                <td><button onclick="handleButtonClick(this)" s-no="4" no-of-ads="5" amount="55">Get
                                        This Plan</button>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>8</td>
                                <td>₹ 80 /-</td>
                                <td><button onclick="handleButtonClick(this)" s-no="5" no-of-ads="8" amount="80">Get
                                        This Plan</button>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>10</td>
                                <td>₹ 90 /-</td>
                                <td><button onclick="handleButtonClick(this)" s-no="6" no-of-ads="10" amount="90">Get
                                        This Plan</button>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>12</td>
                                <td>₹ 96 /-</td>
                                <td><button onclick="handleButtonClick(this)" s-no="7" no-of-ads="12" amount="96">Get
                                        This Plan</button>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>15</td>
                                <td>₹ 105 /-</td>
                                <td><button onclick="handleButtonClick(this)" s-no="8" no-of-ads="15" amount="105">Get
                                        This
                                        Plan</button></td>
                            </tr>
                            <tr>
                                ...
                                <td>20</td>
                                <td>₹ 120 /-</td>
                                <td><button onclick="handleButtonClick(this)" s-no="9" no-of-ads="20" amount="120">Get
                                        This
                                        Plan</button></td>
                            </tr>
                            <tr>
                                ...
                                <td>25</td>
                                <td>₹ 125 /-</td>
                                <td><button onclick="handleButtonClick(this)" s-no="10" no-of-ads="25" amount="125">Get
                                        This
                                        Plan</button></td>
                            </tr>
                            ...
                            <script>
                                function handleButtonClick(button) {
                                    const sno = button.getAttribute('s-no');
                                    const no_of_ads = button.getAttribute('no-of-ads');
                                    const amount = button.getAttribute('amount');

                                    // Create a form element dynamically
                                    const form = document.createElement('form');
                                    form.method = 'POST'; // Set the form method to POST
                                    form.action = 'checkout/index.php'; // Set the action to your PHP file
                                    ...
                                    adsInput.type = 'hidden';
                                    adsInput.name = 'no_of_ads';
                                    adsInput.value = no_of_ads;
                                    form.appendChild(adsInput);
                ...
                <div class="container">
                    <div class="title-wrapper">
                        ...
                        <ul class="avatar-list">
                            <li class="avatar">
                                <img src="./assets/images/avatar-1.jpg" width="120" height="80" loading="lazy"
                                    alt="John smith" class="img-cover" />
                            </li>

                            <li class="avatar">
                                <img src="./assets/images/avatar-2.jpg" width="120" height="80" loading="lazy"
                                    alt="John smith" class="img-cover" />
                            </li>

                            <li class="avatar">
                                <img src="./assets/images/avatar-3.jpg" width="120" height="80" loading="lazy"
                                    alt="John smith" class="img-cover" />
                            </li>

                            <li class="avatar">
                                <img src="./assets/images/avatar-4.jpg" width="120" height="80" loading="lazy"
                                    alt="John smith" class="img-cover" />
        ...
        <div class="footer-top">
            <div class="container">
                ...
                <nav class="footer-nav" aria-labelledby="nav-label-2">
                    ...
                    <ul class="footer-list">
                        <li>
                            <a href="mailto:www.debhal@gmail.com" class="body-medium footer-link">Email -
                                www.debhal@gmail.com</a>
                        </li>
                        <li>
                            <a href="tel:918100152848" class="body-medium footer-link">Mobile Number - +91
                                81001-52848</a>
                        </li>
                        <li>
                ...
                <nav class="footer-nav" aria-labelledby="nav-label-3">
                    ...
                    <ul class="footer-list">
                        <li>
                            <a href="mailto:www.debhal@gmail.com"
                                class="body-medium footer-link">www.debhal@gmail.com</a>
                        </li>
                        ...
                        <li>
                            <ul class="social-list">
                                <li>
                                    <a href="https://www.facebook.com/profile.php?id=61566534188109&mibextid=ZbWKwL"
                                        class="social-link">
                                ...
                                <li>
                                    <a href="https://www.instagram.com/debhal.in/profilecard/?igsh=cm5kOGdxNzUxOGRx"
                                        class="social-link">
